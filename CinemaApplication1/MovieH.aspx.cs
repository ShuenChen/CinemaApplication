...
namespace CinemaApplication1
{
    public partial class WebForm9 : System.Web.UI.Page
    {
        ...
        {
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand commandImageUpload = new SqlCommand("SELECT distinct Movie.MovieName,Movie.MovieId,Movie.image_path FROM Movie LEFT JOIN Ticket ON Movie.MovieId = Ticket.movieId WHERE Ticket.available = 'Yes' AND Movie.Category='H'", connection);
            connection.Open();
