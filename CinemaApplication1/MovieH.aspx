<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MovieH.aspx.cs" Inherits="CinemaApplication1.WebForm9" %>
        ...
        <div class="row">
            <div class="title col-md-2 border-end border-warning">
                <ul style="list-style:none;">
                    ...
                    <li><a href="MovieH.aspx" class="link" style="color:yellow;">Hottest Movies</a></li>
