<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MemberRegister.aspx.cs" Inherits="CinemaApplication1.WebForm6" %>
    ...
    <div class="w-50 mx-auto my-5 py-4 bg-dark p-md-5 container-fluid" style="opacity: 0.9;">
        <div class="row">
            <div class="container-fluid col-lg-8">
                <br>
                <h2 class="text-warning text-left">Register As Our Member</h2>
                <br>
                <div class="form-group text-warning w-auto">
                    <label for="uname"><i class="fa fa-user" style="font-size: 24px"></i> Name </label>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtName" CssClass="error" Display="Dynamic" ErrorMessage="Please fill in your name"></asp:RequiredFieldValidator>
                    <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtName" CssClass="error" Display="Dynamic" ErrorMessage="The user name have been used " OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator>
                ...
                <div class="form-group text-warning w-auto">
                    ...
                    <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtForgetPwdAnswer" CssClass="error" Display="Dynamic" ErrorMessage="Cannot Insert Invalid Word" OnServerValidate="CustomValidator8_ServerValidate"></asp:CustomValidator>
                ...
                <br />
                <asp:Button ID="Register" runat="server" class="btn btn-dark btn-outline-warning" Text="Register" OnClick="Register_Click" />
                ...
                <br />
                <br />
                <asp:HyperLink ID="Loginnow" CssClass="text-warning" NavigateUrl="~/MemberLogin.aspx" runat="server">Already have an account? Login now</asp:HyperLink>
            </div>
        </div>
    </div>
    <br />
