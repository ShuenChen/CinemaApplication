<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MovieP.aspx.cs" Inherits="CinemaApplication1.WebForm10" %>
        ...
        <div class="row">
            <div class="title col-md-2 border-end border-warning">
                <ul style="list-style:none;">
                    ...
                    <li><a href="MovieN.aspx" class="link">New Movies</a></li>
                    <li><a href="MovieP.aspx" class="link" style="color:yellow;">Promotion Movies</a></li>
                </ul>
            </div>
            <div class="col-md-10">
                <br />
